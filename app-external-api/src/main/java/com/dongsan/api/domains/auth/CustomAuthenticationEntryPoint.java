...
public class CustomAuthenticationEntryPoint implements AuthenticationEntryPoint {
	...
	public void commence(HttpServletRequest request, HttpServletResponse response,
		...
		ApiErrorCode errorCode =
			errorObj instanceof ApiErrorCode ? (ApiErrorCode)errorObj : ApiErrorCode.AUTHENTICATION_FAILED;
		ResponseEntity<ErrorResponse> errorResponse = ResponseEntity.status(errorCode.getHttpStatus())
			.body(
