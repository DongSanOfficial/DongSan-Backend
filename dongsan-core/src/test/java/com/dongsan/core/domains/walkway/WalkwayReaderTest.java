...
class WalkwayReaderTest {
	...
	class Describe_getCanReviewWalkwayHistory {
		...
		void it_returns_walkway_history() {
			...
			when(walkwayRepository.getCanReviewWalkwayHistory(walkwayId, memberId, size, null)).thenReturn(
				walkwayHistories);
	...
	class Describe_getUserCanReviewWalkwayHistory {
		...
		void it_returns_walkway_history() {
			...
			when(walkwayRepository.getUserCanReviewWalkwayHistory(memberId, size, lastCreatedAt)).thenReturn(
				walkwayHistories);
