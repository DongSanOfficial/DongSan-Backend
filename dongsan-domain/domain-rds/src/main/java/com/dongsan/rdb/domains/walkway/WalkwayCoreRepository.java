...
public class WalkwayCoreRepository implements WalkwayRepository {
    ...
    public Long saveWalkway(CreateWalkway createWalkway) {
        ...
        WalkwayEntity walkwayEntity = new WalkwayEntity(createWalkway, member);
        return walkwayJpaRepository.save(walkwayEntity)
                .getId();
    }
    ...
    public void updateWalkway(UpdateWalkway updateWalkway) {
        ...
        walkwayEntity.updateWalkway(updateWalkway.name(), updateWalkway.memo(), updateWalkway.exposeLevel(),
    ...
    public List<Walkway> getUserLikedWalkway(Long memberId, Integer size, LocalDateTime lastCreatedAt) {
        List<WalkwayEntity> walkwayEntities = walkwayQueryDSLRepository.getUserLikedWalkway(memberId, size,
                lastCreatedAt);
        return walkwayEntities.stream()
                .map(WalkwayEntity::toWalkway)
                .toList();
    ...
    public Long saveLikedWalkway(Long memberId, Long walkwayId) {
        ...
        LikedWalkwayEntity likedWalkwayEntity = likedWalkwayJpaRepository.save(
                new LikedWalkwayEntity(member, walkwayEntity));
    ...
    public Long saveWalkwayHistory(CreateWalkwayHistory createWalkwayHistory) {
        ...
        WalkwayHistoryEntity walkwayHistoryEntity
                = new WalkwayHistoryEntity(member, walkwayEntity, createWalkwayHistory.distance(),
    ...
    public List<WalkwayHistory> getCanReviewWalkwayHistory(Long walkwayId, Long memberId, int size,
        ...
        List<WalkwayHistoryEntity> walkwayHistoryEntities =
                walkwayHistoryQueryDSLRepository.getCanReviewWalkwayHistories(
    ...
    public List<WalkwayHistory> getUserCanReviewWalkwayHistory(Long memberId, int size, LocalDateTime lastCreatedAt) {
        List<WalkwayHistoryEntity> walkwayHistoryEntities =
                walkwayHistoryQueryDSLRepository.getUserCanReviewWalkwayHistories(
