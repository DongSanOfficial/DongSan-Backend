...
public class SwaggerConfig {
    ...
    public OpenAPI OpenApiConfig() {
        ...
        OpenAPI openApi = new OpenAPI()
                ...
                .tags(List.of(
                        new Tag().name(SOCIAL_TAG_NAME)
                                .description("Oauth2 Endpoint"),
                        new Tag().name("개발용 API")
                                .description("Develop API"),
                        new Tag().name("산책로")
                                .description("Walkway"),
                        new Tag().name("산책로 리뷰")
                                .description("Review of Walkway"),
                        new Tag().name("북마크")
                ...
                .path("/oauth2/authorization/apple", oauth2PathItem(Provider.APPLE));
                        ...
                        .addApiResponse("302", new ApiResponse()
                                .content(new Content().addMediaType("application/json",
                                        new MediaType().schema(new Schema<Map<String, String>>()
                                                ...
                                                .example(Map.of(
                                                                "Set-Cookie",
                                                                "accessToken=; Max-Age=3600; Path=/; Domain=dongsanwalk.site; HttpOnly=false; "
                                                                        + "Secure=true, refreshToken=; Max-Age=3600; Path=/; Domain=dongsanwalk.site;"
