...
public class ReviewController {
	...
	public ResponseEntity<CreateReviewResponse> createReview(
		...
		CreateReview createReview
			= new CreateReview(customOAuth2User.getMemberId(), walkwayId, request.walkwayHistoryId(),
			Rating.numOf(request.rating()), request.content());
	...
	public ResponseEntity<CursorResponse<WalkwayReviewsResponse>> getWalkwayReviews(
		...
		PagingResponse<Review> response
			= reviewService.getWalkwayReviews(sort, walkwayId, customOAuth2User.getMemberId(),
