...
public class WalkwayController {
	...
	@Autowired
	public WalkwayController(WalkwayService walkwayService, BookmarkService bookmarkService,
		S3FileService s3FileService, ImageService imageService) {
	...
	public ResponseEntity<CursorResponse<BookmarksWithMarkedWalkwayResponse>> getBookmarksWithMarkedWalkway(
		...
		PagingResponse<BookmarkWithMarkedStatus> response
			= bookmarkService.getBookmarksWithMarkedWalkway(customOAuth2User.getMemberId(), walkwayId,
