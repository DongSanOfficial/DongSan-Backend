...
public class ReviewEntity extends BaseEntity {
	...
	public ReviewEntity(Rating rating, String content, MemberEntity member, WalkwayEntity walkway,
		WalkwayHistoryEntity walkwayHistory) {
	...
	public Review toReview() {
		return new Review(id, new Reviewer(member.getId(), member.getNickname()), walkway.toReviewedWalkway(),
			Rating.numOf(rating), content, getCreatedAt());
	}
